...
import type {ILoanHistory} from "./loan-history.types";
import loanHistoryModel from "./loan-history.model";
...
export class LoanHistoryRepository extends BaseRepository<ILoanHistory> {
    constructor() {
        super(loanHistoryModel);
    }

    index = async ({filters, search, sort: sorter, pageNumber, pageSize, column}: IIndexParam): Promise<Aggregate<ILoanHistory>> => {
        //@ts-expect-error
