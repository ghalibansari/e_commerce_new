...
import transactionSaleModel from "./sale.model";
...
export class TransactionSaleRepository extends BaseRepository<ITransactionSale> {
    constructor(){
        super(transactionSaleModel)
    }
    ...
    async getSkuIds( transactionId: any): Promise<ISku[]> {
        let transactionData: any = await transactionSaleModel.findOne({ transactionId: transactionId });
