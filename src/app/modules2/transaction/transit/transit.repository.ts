...
import transactionTransitModel from "./transit.model";
...
export class TransactionTransitRepository extends BaseRepository<ITransactionTransit> {
    constructor(){
        super(transactionTransitModel)
    }
    ...
    async getSkuIds( transactionId: any): Promise<ISku[]> {
        let transactionData: any = await transactionTransitModel.findOne({ transactionId: transactionId });
